...
# Email configuration
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='foodOnline Marketplace <django.foodonline@gmail.com>')
DEBUG_EMAIL = config('DEBUG_EMAIL', default='True') == 'True'
